...
_URL_DERIVATIVES = 'v1/data/instrument_metrics.{data_version}/exchanges/{exchange}/{instrument_class}/{instrument}/full'
...
class Derivatives(KaikoData):
    """
    Derivatives Data
    """
    def __init__(self, exchange, instrument, instrument_class: str = 'future', data_version = 'latest', params: dict = dict(page_size=100000),
                 client=None,
                 **kwargs):
        ...
        self.parameter_space = 'start_time,end_time,page_size,sort'.split(',')

        endpoint = _URL_DERIVATIVES
